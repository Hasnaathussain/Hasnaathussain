...
Six focused fixes have merged upstream, and eight additional upstream PRs are in maintainer review or repository-controlled CI gates. Each contribution is a small, tested change tied to a concrete failure mode.
