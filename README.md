...
| :--- | :--- | :--- | :--- |
| <img src="https://github.com/pydantic.png" width="20"> **[pydantic/pydantic-ai](https://github.com/pydantic/pydantic-ai)** | `★ 8k+` | [PR #6105](https://github.com/pydantic/pydantic-ai/pull/6105) (Closed)<br>[PR #6096](https://github.com/pydantic/pydantic-ai/pull/6096) (Closed)<br>[PR #6098](https://github.com/pydantic/pydantic-ai/pull/6098) (Open) | **Gemini 3, Bedrock Converse, & TestModel metadata:** Gated Gemini 3 tool configurations, resolved Bedrock Converse API `ValidationException` when user turns carry media/attachment files immediately after tool results, and aligned provider name metadata in TestModel responses. |
