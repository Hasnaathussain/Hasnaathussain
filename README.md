...
| :--- | :--- | :--- | :--- |
| <img src="https://github.com/pydantic.png" width="20"> **[pydantic/pydantic-ai](https://github.com/pydantic/pydantic-ai)** | `★ 8k+` | [PR #6105](https://github.com/pydantic/pydantic-ai/pull/6105) (Closed)<br>[PR #6096](https://github.com/pydantic/pydantic-ai/pull/6096) (Closed)<br>[PR #6098](https://github.com/pydantic/pydantic-ai/pull/6098) (Merged) | **Gemini 3, Bedrock Converse, & TestModel metadata:** Gated Gemini 3 tool configurations, resolved Bedrock Converse API `ValidationException` when user turns carry media/attachment files immediately after tool results, and aligned provider name metadata in TestModel responses. |
| <img src="https://github.com/run-llama.png" width="20"> **[run-llama/llama_index](https://github.com/run-llama/llama_index)** | `★ 50k` | [PR #22200](https://github.com/run-llama/llama_index/pull/22200) (Open) | **Production Stability & Resiliency:** Integrated missing timeouts in OneDriveReader's HTTP calls to prevent indefinite socket-blocking and potential thread starvation. |
...
| <img src="https://github.com/ashishpatel26.png" width="20"> **[ashishpatel26/500-AI-Agents-Projects](https://github.com/ashishpatel26/500-AI-Agents-Projects)** | `★ 1.8k` | [PR #109](https://github.com/ashishpatel26/500-AI-Agents-Projects/pull/109) (Open) | **Agent Use Cases Catalog:** Contributed 15 framework-grouped agent use cases across CrewAI, LangGraph, and AutoGen. |
| <img src="https://github.com/e2b-dev.png" width="20"> **[e2b-dev/awesome-ai-agents](https://github.com/e2b-dev/awesome-ai-agents)** | `★ 4.2k` | [PR #840](https://github.com/e2b-dev/awesome-ai-agents/pull/840) (Open) | **Ecosystem Additions:** Contributed reference links and tool integrations for custom multi-agent execution engines. |
...
| <img src="https://github.com/keras-team.png" width="20"> **[keras-team/keras](https://github.com/keras-team/keras)** | `★ 60k` | [PR #23217](https://github.com/keras-team/keras/pull/23217) (Open)<br>[PR #23222](https://github.com/keras-team/keras/pull/23222) (Open) | **Deserialization & Dataset Class Weights:** Validates trainable flags as booleans during deserialization. Optimizes model dataset generation and prevents empty dictionary class_weight crashes while providing strict validation on target label key matching. |
| <img src="https://github.com/pallets.png" width="20"> **[pallets/click](https://github.com/pallets/click)** | `★ 16k` | [PR #3668](https://github.com/pallets/click/pull/3668) (Open) | **CLI Progress Indicators:** Flushes remaining steps on completion inside ProgressBar when a custom update step is set. |
| <img src="https://github.com/pallets.png" width="20"> **[pallets/flask](https://github.com/pallets/flask)** | `★ 68k` | [PR #6083](https://github.com/pallets/flask/pull/6083) (Open) | **Testing Suite Resiliency:** Restores test suite collection compatibility under Pytest 9.1+ by fallback importing the renamed `NOTSET` monkeypatch sentinel. |
| <img src="https://github.com/pallets.png" width="20"> **[pallets/werkzeug](https://github.com/pallets/werkzeug)** | `★ 7k` | [PR #3204](https://github.com/pallets/werkzeug/pull/3204) (Open) | **URL Processing Standards:** Preserves empty but present username/password segments in `uri_to_iri` and `iri_to_uri` mapping logic. |
| <img src="https://github.com/pallets.png" width="20"> **[pallets/jinja](https://github.com/pallets/jinja)** | `★ 10k` | [PR #2212](https://github.com/pallets/jinja/pull/2212) (Open) | **Template Cache Protection:** Intercepts invalid dictionary template names to raise clear TypeErrors early, resolving unhashable cache key crashes under Python 3.14. |
...
<p align="center">
  <a href="https://github.com/Hasnaathussain"><img src="https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white" /></a>
  <a href="https://www.linkedin.com/in/hasnaathussain/"><img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" /></a>
  <a href="mailto:hasnaat.hussain.2@gmail.com"><img src="https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white" /></a>
</p>
